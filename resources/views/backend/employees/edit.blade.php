                        ...
                        <div class="card-body">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    placeholder="Enter First Name" value="{{ $getRecord->name }}" required>
                                    @error('name')
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    placeholder="Enter Email ID" value="{{ $getRecord->email }}" required>
                                    @error('email')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="date" class="form-control @error('hire_date') is-invalid @enderror" name="hire_date"
                                        value="{{ $getRecord->hire_date }}" required>
                                    @error('hire_date')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    placeholder="Enter Salary" value="{{ $getRecord->salary }}" required>
                                    @error('salary')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    placeholder="Enter Commission PCT" value="{{ $getRecord->commission_pct }}" required>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <select name="manager_id" class="form-control @error('manager_id') is-invalid @enderror" required>
                                        ...
                                        <option {{ ($getRecord->manager_id) == 1 ? 'selected' : '' }} value="1">abc</option>
                                        <option {{ ($getRecord->manager_id) == 2 ? 'selected' : '' }} value="2">xyz</option>
                                    </select>
                                    @error('manager_id')
                                    <div class="invalid-feedback">
                                        {{ $message }}
