                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control @error('name') is-invalid @enderror"
                                            name="name" placeholder="Enter First Name" value="{{ $getRecord->name }}"
                                            required>
                                        @error('name')
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="last_name"
                                            placeholder="Enter Last Name" value="{{ $getRecord->last_name }}">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="email" class="form-control @error('email') is-invalid @enderror"
                                            name="email" placeholder="Enter Email ID" value="{{ $getRecord->email }}"
                                            required>
                                        @error('email')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="date" class="form-control @error('hire_date') is-invalid @enderror"
                                            name="hire_date" value="{{ $getRecord->hire_date }}" required>
                                        @error('hire_date')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <select name="job_id" class="form-control @error('job_id') is-invalid @enderror"
                                            ...
                                            <option value="{{ $job->id }}" {{ $job->id == $getRecord->job_id ?
                                                'selected' : '' }}>
                                                {{ $job->job_title }}
                                            </option>
                                            @endforeach
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="number" class="form-control @error('salary') is-invalid @enderror"
                                            name="salary" placeholder="Enter Salary" value="{{ $getRecord->salary }}"
                                            required>
                                        @error('salary')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="number"
                                            ...
                                            name="commission_pct" placeholder="Enter Commission PCT"
                                            value="{{ $getRecord->commission_pct }}" required>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <select name="manager_id"
                                            class="form-control @error('manager_id') is-invalid @enderror" required>
                                            <option value="">Select Manager Name</option>
                                            <option {{ ($getRecord->manager_id) == 1 ? 'selected' : '' }} value="1">abc
                                            </option>
                                            <option {{ ($getRecord->manager_id) == 2 ? 'selected' : '' }} value="2">xyz
                                            </option>
                                        </select>
                                        @error('manager_id')
                                        <div class="invalid-feedback">
                                    ...
                                    <div class="col-sm-10">
                                        <select name="department_id"
                                            ...
                                            <option {{ ($getRecord->department_id) == 1 ? 'selected' : '' }}
                                                value="1">Developer Department</option>
                                            <option {{ ($getRecord->department_id) == 2 ? 'selected' : '' }}
                                                value="2">BDM Department</option>
                                        </select>
                                        @error('department_id')
                                        <div class="invalid-feedback">
                                            {{ $message }}
